...
class MemberService{
    ...
    public async updateMemberPhone(memberId: string, memberPhone: string): Promise<Member> {
        try {
            ...
            const result = await this.memberModel
                .findByIdAndUpdate(
                    memberObjectId,
                    { memberPhone: memberPhone, updatedAt: new Date() },
    ...
    public async updateMemberNick(memberId: string, memberNick: string): Promise<Member> {
        try {
            console.log("=== UPDATE NICK SERVICE ===");
            console.log("Member ID (string):", memberId);
            console.log("New Nick:", memberNick);
            ...
            const result = await this.memberModel
                .findByIdAndUpdate(
                    memberObjectId,
                    { memberNick: memberNick, updatedAt: new Date() },
                    { new: true, runValidators: true }
                )
                .exec();
            ...
            console.log("Nick updated successfully:", result.memberNick);
            console.log("Updated member:", result);
            return result as unknown as Member;
